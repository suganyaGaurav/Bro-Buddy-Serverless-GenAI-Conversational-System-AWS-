...
def build_system_prompt(mode: str) -> str:
    ...
    base_prompt = (
        ...
        "- - Always close the explanation with a short summary or conclusion.\n\n"
    ...
    # --------------------------------------------------
        ...
        mode_prompt = (
            ...
            "- Limit response to 6–8 short paragraphs.\n"
            "- Avoid unnecessary elaboration.\n"
            "- - Ensure answers feel complete and self-contained before ending.\n"
        )
